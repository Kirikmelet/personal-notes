...
#+begin_quote
[!info]
If we don't have a calculator value, there is a theorem used for [[#Trapezoidal%20Rule][Trapezoidal Rule]]
\[
|E_T| \leq \frac{K(b-a)^3}{12n^2}
\] 
for [[#Midpoint%20Rule][Midpoint Rule]]
\[
|E_M| \leq \frac{K(b-a)^3}{24n^2}
\]
and for [[#Simpson's%20Rule][Simpson's Rule]]
\[
