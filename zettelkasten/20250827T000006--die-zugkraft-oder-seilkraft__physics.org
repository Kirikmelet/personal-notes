...
- /Dynamischer Fall (Beschleunigung):/ Zwei Massen (\(m_1, m_2\)) sind durch ein Seil über eine Rolle verbunden (Atwood'sche Fallmaschine). Die Zugkraft \(T\) wird durch das Aufstellen der Bewegungsgleichungen für /beide/ Massen bestimmt und ist in beiden Gleichungen gleich groß.