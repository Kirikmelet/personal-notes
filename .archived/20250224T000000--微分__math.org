...
- German: Die Differenzialrechnung
#+end_quote
...
| （逆）正弦  | \(\frac{d}{dx}\sin^{-1}{x}=\frac{1}{\sqrt{1-x^2}}\)                      |     |
| （逆）余弦  | \(\frac{d}{dx}\cos^{-1}{x}=\frac{-1}{\sqrt{1-x^2}}\)                     |     |
| （逆）正接  | \(\frac{d}{dx}\tan^{-1}{x}=\frac{1}{1+x^2}\)                             |     |
| （逆）生割  | \(\frac{d}{dx}\frac{2}{\sec}{x}=\frac{1}{\lvert x \rvert\sqrt{1-x^2}}\)  |     |
