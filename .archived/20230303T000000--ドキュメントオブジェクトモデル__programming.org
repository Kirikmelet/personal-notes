...
#+date: [2023-03-03 Fri 00:00]
#+filetags: :programming:
#+identifier: 20230303T000000

* ドキュメントオブジェクトモデル


什么是“文档对象模型”， 还是DOM？
DOM是对象的数据表示，包括网络上的构建和内容。

「ドキュメント・オブジェクト・モデル」、「DOM」と言う、は何ですか？


#+begin_quote
[!info] 信息
更多信息: [[<>][https://www.w3.org/TR/WD-DOM/introduction.html]]
#+end_quote

** 特徴

こちらはドキュメントオブジェクトモデルの特徴です：
