...
#+date: [2025-12-03 Wed 00:00]
#+filetags: :physics:
#+identifier: 20251203T000000
...
2.  /Winkelverschiebung (\(\Delta \theta\)):/
    ...
    -   Definition: \[
\Delta \theta = \theta(t + \Delta t) - \theta(t) = \theta_f - \theta_i
\]
...
\]
    ...
    -   /Zusammenhang mit Bahngeschwindigkeit:/ Für einen Punkt im Abstand \(r\) von der Drehachse gilt: \[
v = \omega r
\]
...
\]
    -   /Zusammenhang mit Tangentialbeschleunigung:/ Für einen Punkt im Abstand \(r\) von der Drehachse gilt: \[
a_t = \alpha r
\]
...
1.  /Winkelgeschwindigkeit-Zeit-Gesetz:/ \[
\omega(t) = \omega_0 + \alpha \cdot \Delta t
\]
2.  /Winkelposition-Zeit-Gesetz:/ \[
\theta(t) = \theta_0 + \omega_0 \cdot t + \frac{1}{2} \alpha \cdot \Delta t^2
\]
3.  /Winkelgeschwindigkeit-Position-Gesetz (zeitunabhängige Gleichung):/ \[
\omega^2(t) = \omega_0^2 + 2 \alpha \cdot \Delta \theta
\]
4.  /Winkelverschiebungs-Gesetz:/ \[
\Delta \theta = \frac{1}{2} \cdot (\omega_0 + \omega(t)) \cdot \Delta t
\] \[
