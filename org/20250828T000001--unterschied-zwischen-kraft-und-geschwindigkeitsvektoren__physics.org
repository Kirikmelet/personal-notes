...
​  
/Die Kraft ist proportional zur /Änderungsrate/ des Geschwindigkeitsvektors (also zur Beschleunigung \(\vec{a} = \frac{d\vec{v}}{dt}\)), nicht zur Geschwindigkeit selbst./
